...
import '../style.css';
import wolve1 from '../wolves/wolf4.png';
import soundfile from '../voices/EN/Story4_EN.mp3';
import soundfileCZ from '../voices/CZ/Story4_CZ.mp3';
...
import Table from './wolf4table';
import Table1 from './wolf4table';

class Wolf4 extends React.Component {
    constructor(props){
        super(props)
        this.state={
            play : false,
    ...
    render (){
        ...
        return (
            <div className="wolvesdiv">   
                                ...
                                <Link className="links" to="/locwolf4">
                                <b className="intro textalign">
                                Subway underpass at<br/> Náměstí Republiky<br/>
...
<br/>
                                    ...
                                    <Translation>
                                {
                                    t =>  <p className = "textalign">{t("Am_I_only_material")}</p>
                                    }
                                </Translation>
  ...
  export default withTranslation("translations")(Wolf4);