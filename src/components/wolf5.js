...
import '../style.css';
import wolve1 from '../wolves/wolf5.png';
import soundfile from '../voices/EN/Story5_EN.mp3';
import soundfileCZ from '../voices/CZ/Story5_CZ.mp3';
...
import Table1 from './wolf5table';

class Wolf5 extends React.Component {
    constructor(props){
        super(props)
        this.state={
            play : false,
    ...
    render (){
        ...
        return (
            <div className="wolvesdiv">   
                                ...
                                <Link className="links" to="/locwolf5">
                                <b className="intro textalign">
                                Subway underpass at<br/> Můstek station <br/>
...
<br/>
                                    ...
                                    <Translation>
                                {
                                    t =>  <p className = "textalign">{t("DoIHaveAgency")}</p>
                                    }
                                </Translation>
  ...
  export default withTranslation("translations")(Wolf5);