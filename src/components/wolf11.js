...
import '../style.css';
import wolve1 from '../wolves/wolf11.png';
import soundfile from '../voices/EN/Story11_EN.mp3';
import soundfileCZ from '../voices/CZ/Story11_CZ.mp3';
...
import Table1 from './wolf11table';

class Wolf11 extends React.Component {
    constructor(props){
        super(props)
        this.state={
            play : false,
    ...
    render (){
        ...
        return (
            <div className="wolvesdiv">   
                                ...
                                <Link className="links" to="/locwolf11">
...
<br/>
                                    ...
                                    <Translation>
                                {
                                    t =>  <p className = "textalign">{t("Can_you_really")}</p>
                                    }
                                </Translation>
  ...
  export default withTranslation("translations")(Wolf11);    