...
import '../style.css';
import wolve1 from '../wolves/wolf8.png';
import soundfile from '../voices/EN/Story8_EN.mp3';
import soundfileCZ from '../voices/CZ/Story8_CZ.mp3';
...
import Table1 from './wolf8table';

class Wolf8 extends React.Component {
    constructor(props){
        super(props)
        this.state={
            play : false,
    ...
    render (){
        ...
        return (
            <div className="wolvesdiv">   
                                ...
                                <Link className="links" to="/locwolf8">
...
<br/>  
                                    ...
                                    <Translation>
                                {
                                    t =>  <p className = "textalign">{t("Am_I_fixated")}</p>
                                    }
                                </Translation>
  ...
  export default withTranslation("translations")(Wolf8);