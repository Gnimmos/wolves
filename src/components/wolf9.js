...
import '../style.css';
import wolve1 from '../wolves/wolf9.png';
import soundfile from '../voices/EN/Story9_EN.mp3';
import soundfileCZ from '../voices/CZ/Story9_CZ.mp3';
...
import Table1 from './wolf9table';

class Wolf9 extends React.Component {
    constructor(props){
        super(props)
        this.state={
            play : false,
    ...
    render (){
        ...
        return (
            <div className="wolvesdiv">   
                                ...
                                <Link className="links" to="/locwolf9">
                                <b className="intro textalign">
                                Česká Spořitelna - Libeň <br/>
                                Zenklova 21, 180 00 Prague 8 <br/>
                                180 00 Prague 8  <br/>
                                </b>
                                    <br/>
...
<br/>
                                    ...
                                    <Translation>
                                {
                                    t =>  <p className = "textalign">{t("Do_I_Control")}</p>
                                    }
                                </Translation>
  ...
  export default withTranslation("translations")(Wolf9);