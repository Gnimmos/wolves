...
import '../style.css';
import wolve1 from '../wolves/wolf10.png';
import soundfile from '../voices/EN/Story10_EN.mp3';
import soundfileCZ from '../voices/CZ/Story10_CZ.mp3';
...
import Table1 from './wolf10table';

class Wolf10 extends React.Component {
    constructor(props){
        super(props)
        this.state={
            play : false,
    ...
    render (){
        ...
        return (
            <div className="wolvesdiv">   
                                ...
                                <Link className="links" to="/locwolf10">
                                <b className="intro textalign">
                                National Technical<br/>Library - Foyer <br/>
                                Technická 2710/6, <br/>
                                160 80 Prague 6 <br/>
                                    </b>
                                    <br/>
...
<br/>
                                    ...
                                    <Translation>
                                {
                                    t =>  <p className = "textalign">{t("I_zoo_assemblage")}</p>
                                    }
                                </Translation>
  ...
  export default withTranslation("translations")(Wolf10);    