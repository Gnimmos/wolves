...
import '../style.css';
import wolve1 from '../wolves/wolf6.png';
import soundfile from '../voices/EN/Story6_EN.mp3';
import soundfileCZ from '../voices/CZ/Story6_CZ.mp3';
...
import Table1 from './wolf6table';

class Wolf6 extends React.Component {
    constructor(props){
        super(props)
        this.state={
            play : false,
    ...
    render (){
        ...
        return (
            <div className="wolvesdiv">   
                                ...
                                <img className = "wolve1" src={wolve1} alt="Logo" width = "200px" height = "400px" onClick={this.playaudio.bind(this)} />
                                ...
                                <Link className="links" to="/locwolf6">
                                <b className="intro textalign">
                                Tranzit <br/>
                                Dittrichova 13/337,  <br/>
                                120 00 Prague 2<br/>
                                    <br/></b>
                                    <br/>
...
<br/>
                                    ...
                                    <Translation>
                                {
                                    t =>  <p className = "textalign">{t("Can_I_Resist")}</p>
                                    }
                                </Translation>
  ...
  export default withTranslation("translations")(Wolf6);